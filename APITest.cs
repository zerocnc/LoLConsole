...
{
    #region Champion Class
    /**********************************************************************************************
         * Type: Response Classes
         * Return Value: ChampionListDto
         * URL: /api/lol/{region}/v1.1/champion
    ...
    public class Champion
    {
        ...
        [JsonProperty(PropertyName = "defenseRank")]
        public int defenseRank { get; set; }

        // Champion attack rank.
        [JsonProperty(PropertyName = "attackRank")]
        ...
        [JsonProperty(PropertyName = "difficultyRank")]
        ...
        // Champion magic rank.
        [JsonProperty(PropertyName = "magicRank")]
